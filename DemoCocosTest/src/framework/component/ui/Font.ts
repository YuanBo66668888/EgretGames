        ...
        public static createNumber(n: number,pre_name: string,jianju?: number): Font {
            ...
            if(n != 0) {
                while(n != 0) {
                    var bit = n % 10;
                    n = Math.floor(n / 10);
                    var BP: egret.Bitmap = UY.ImageManager.getInstance().createWithSpriteFrameName(pre_name + bit);
                    if(jianju) {
                ...
                var BP: egret.Bitmap = UY.ImageManager.getInstance().createWithSpriteFrameName(pre_name + "0");
                BP.y = 5;
                ret.addChild(BP);
            }
            return ret;
		...
		public changeFont(n:number) {
            ...
            if(n != 0) {
                while(n != 0) {
                    var bit = n % 10;
                    n = Math.floor(n / 10);
                    var BP: egret.Bitmap = UY.ImageManager.getInstance().createWithSpriteFrameName(this.current_font + bit);
                ...
                var BP: egret.Bitmap = UY.ImageManager.getInstance().createWithSpriteFrameName(this.current_font + "0");
                BP.y = 5;
                this.addChild(BP);
            }
		}
