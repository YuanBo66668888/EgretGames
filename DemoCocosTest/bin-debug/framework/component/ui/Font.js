...
(function (UY) {
        ...
        Font.createNumber = function (n, pre_name, jianju) {
            ...
            if (n != 0) {
                while (n != 0) {
                    var bit = n % 10;
                    n = Math.floor(n / 10);
                    var BP = UY.ImageManager.getInstance().createWithSpriteFrameName(pre_name + bit);
                    if (jianju) {
                ...
                var BP = UY.ImageManager.getInstance().createWithSpriteFrameName(pre_name + "0");
                BP.y = 5;
                ret.addChild(BP);
            }
            return ret;
        ...
        p.changeFont = function (n) {
            ...
            if (n != 0) {
                while (n != 0) {
                    var bit = n % 10;
                    n = Math.floor(n / 10);
                    var BP = UY.ImageManager.getInstance().createWithSpriteFrameName(this.current_font + bit);
                ...
                var BP = UY.ImageManager.getInstance().createWithSpriteFrameName(this.current_font + "0");
                BP.y = 5;
                this.addChild(BP);
            }
        };
    ...
    UY.Font = Font;
    egret.registerClass(Font,'UY.Font');
})(UY || (UY = {}));
