...
AssetAdapter = function() {
    function e() {}
    return e.prototype.getAsset = function() {},
    e
} ();
...
var ByteArrayMsgByProtobuf = function() {
    function e() {}
    return e
} ();
...
var Main = function(e) {
    ...
    t.prototype.createGameScene = function() {
        ...
        o = this.stage.stageHeight;
        e.width = t,
        e.height = o;
        var r = new egret.Shape;
        r.graphics.beginFill(0, .5),
        r.graphics.drawRect(0, 0, t, 172),
        r.graphics.endFill(),
        r.y = 33,
        this.addChild(r);
        ...
        n.graphics.lineStyle(2, 16777215),
        n.graphics.moveTo(0, 0),
        n.graphics.lineTo(0, 117),
        n.graphics.endFill(),
        n.x = 172,
        n.y = 61,
        this.addChild(n);
